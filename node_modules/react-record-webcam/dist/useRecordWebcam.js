...
const { REACT_APP_API_URL } = require("../../../src/api");
                        ...
                        const send = async()=>{
                            ...
                            const response = await fetch(`${REACT_APP_API_URL}/videos/`, {
                             ...
                             if(response.ok){
                                ...
                                console.log(data)
                                const num = data.id
                                const numer = Number(data.id)
                                console.log("ah is " + num)
                                console.log("ahaa is " + numer)
                            ...
                            if(data.id > 0){
                                ...
                                data.append('ref', 'videos') // optional, you need it if you want to link the image to an entry
                                data.append('refId', num) // optional, you need it if you want to link the image to an entry
                                data.append('field', 'video') // optional, you need it if you want to link the image to an entry
                                //data.append('source', 'users-permissions');y
            
                                 const ss = await axios.post(`${REACT_APP_API_URL}/upload`, data , {headers: {'Content-Type': 'multipart/form-data'}}) 
                                }
